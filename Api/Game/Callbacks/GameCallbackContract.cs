...
namespace Polaris.API
{
    ...
    internal static class GameCallbackContract
    {
        ...
        static readonly Dictionary<GameInstanceCallbackKind, Type> InstanceData = new()
        {
            ...
            [GameInstanceCallbackKind.EnhancerObtainedChanged] = typeof(EnhancerObtainedChangedCallbackData),
            [GameInstanceCallbackKind.EnhancerActiveChanged] = typeof(EnhancerActiveChangedCallbackData),
            [GameInstanceCallbackKind.SkillObtainedChanged] = typeof(SkillObtainedChangedCallbackData),
            [GameInstanceCallbackKind.SkillEnabledChanged] = typeof(SkillEnabledChangedCallbackData),
            [GameInstanceCallbackKind.SkillManipulationChanged] = typeof(SkillManipulationChangedCallbackData),
        ...
        static readonly Dictionary<GameInstanceCallbackKind, Type> InstanceOwner = new()
        {
            ...
            [GameInstanceCallbackKind.EnhancerObtainedChanged] = typeof(GameEnhancer),
            [GameInstanceCallbackKind.EnhancerActiveChanged] = typeof(GameEnhancer),
            [GameInstanceCallbackKind.SkillObtainedChanged] = typeof(GameSkill),
            [GameInstanceCallbackKind.SkillEnabledChanged] = typeof(GameSkill),
            [GameInstanceCallbackKind.SkillManipulationChanged] = typeof(GameSkill),
